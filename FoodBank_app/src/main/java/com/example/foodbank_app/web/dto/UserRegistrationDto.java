...
public class UserRegistrationDto {
	...
	public UserRegistrationDto(String username, String firstName, String lastName, String password, String DOB, String phoneNum, 
			String email, Integer points, String address, String description, String priorityLeast, String priorityMiddle, 
			String priorityMost, String foodNeeded, String roleType, String donateDetails, String voucherCodes, String myDonations) {
		super();
